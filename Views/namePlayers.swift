...
struct namePlayers: View {
    ...
    var body: some View {
        VStack {
            ...
            Button(action: {
                game.playerNames.append(self.name1)
                game.playerNames.append(self.name2)
                game.playerNames.append(self.name3)
                game.playerNames.append(self.name4)
                game.playerNames.append(self.name5)
                game.playerNames.append(self.name6)
                game.playerNames.append(self.name7)
                game.playerNames.append(self.name8)
                game.makePlayers()
            }) {
                Text("Submit names")
            }
